#' pa_mrfa_full() calculates a parallel analysis using a response data frame
#'
...
#'
#'
pa_mrfa_full <- function(data, scale_num, scale_info, n_sim){
...
parallel_results <- DA.MRFA::parallelMRFA(items_data,
