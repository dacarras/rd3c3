#' fit_grm2_m04_w_config() it fits a graded response model (GRM) using MPLUS and MplusAutomation
#'
...
#'
#'
fit_grm2_m04_w_config <- function(data, scale_num, scale_info, grp_var, grp_txt, grp_ref) {
