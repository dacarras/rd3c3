#' fit_grm2_m03_threshold() it fits a graded response model (GRM) using MPLUS and MplusAutomation
#'
...
#'
#'
fit_grm2_m03_threshold <- function(data, scale_num, scale_info, grp_var, grp_txt, grp_ref) {
