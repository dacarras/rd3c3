#' fit_grm2_align_wjs_wlsmv() it fits a between country GRM with alignment method, 
#' with a complex sample design using MPLUS and MplusAutomation.
#' The "_wjs_" version uses taylor series linearization, using strafication, clusters and weights.
#'
...
#'
#'
fit_grm2_align_wjs_wlsmv <- function(data, scale_num, scale_info) {
